    ...
    <div class="card" style="padding: 28px;">
        <form method="POST" action="{{ route('admin.classes.store') }}" id="create-course-form">
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="description" class="input" placeholder="Objectifs ou informations complémentaires sur le cours...">{{ old('description') }}</textarea>
...
(function () {
    ...
    function filterOptions(query) {
        ...
        options.forEach(opt => {
            ...
            const show = !normalized || name.includes(normalized);
