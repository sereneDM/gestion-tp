...
<body>
    <div class="container">
        <div class="header">
            <h1>📊 Statistiques Globales du Système</h1>
        ...
        <!-- Users Statistics -->
        <h3 style="color: #333; margin-bottom: 1rem;">👥 Utilisateurs</h3>
        ...
        <!-- Classes Statistics -->
        <h3 style="color: #333; margin-bottom: 1rem; margin-top: 2rem;">📚 Classes</h3>
        <div class="stats-grid">
            <div class="stat-card">
        ...
        <!-- TPs & Submissions Statistics -->
        <h3 style="color: #333; margin-bottom: 1rem; margin-top: 2rem;">📝 Travaux Pratiques</h3>
        <div class="stats-grid">
            <div class="stat-card">
        ...
        <h3 style="color: #333; margin-bottom: 1rem; margin-top: 2rem;">✓ Présences</h3>
        <div class="stats-grid">
            <div class="stat-card">
