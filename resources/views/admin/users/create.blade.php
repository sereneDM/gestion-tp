...
<div class="form-wrapper">
    <div class="card">
        ...
        <p class="form-subtitle">Enregistrez un nouvel étudiant, enseignant ou administrateur.</p>

        <div class="info-box">
            <i class="ti ti-info-circle" style="font-size:1.25rem;"></i>
            <div>Un mot de passe temporaire sera généré automatiquement et envoyé par email. L'utilisateur devra le changer lors de sa première connexion.</div>
        </div>
