...
.brand, .stats, .preview { position: relative; z-index: 1; }
...
.stats { display: flex; gap: 12px; margin-top: 2rem; }
...
.stat-val { font-size: 1.4rem; font-weight: 800; color: white; letter-spacing: -0.02em; }
...
<div class="right">
  <div class="login-box">
    ...
    <h2>Connexion</h2>
    <p>Bon retour — sélectionnez votre profil et entrez vos identifiants.</p>
    ...
    <form method="POST" action="{{ route('login') }}">
      ...
      <div class="input-group">
        ...
        <div class="input-wrap">
          ...
          <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="prenom.nom@univ.tn" required autofocus>
        </div>
        @error('email')
